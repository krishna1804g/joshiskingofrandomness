                ...
                <div action=""
                    ...
                    {<div className={`flex justify-end ${addDomain && "border-t-[1px] border-gray-400 mt-5"} `}>
                        <div className={`w-full flex gap-3 justify-end`}>
                            {addDomain && <Button sx={{
                                width: "20%", py: 2, marginY: "20px"
                            }}
                                variant='outlined'
                                onClick={() => setAddDomain(false)} color='error'>
                                Cancel
                            </Button>}
                            <Button type='submit' variant="contained" onClick={() => navigate('/dashboard')} disabled={addDomain && domain?.length > 0}
                                sx={{
